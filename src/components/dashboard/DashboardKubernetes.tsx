  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid gap-4">
        {[
          { name: "prod-api-cluster", type: "EKS", nodes: 12, utilization: 42, waste: "$420/mo", status: "Healthy" },
          { name: "staging-worker-pool", type: "AKS", nodes: 4, utilization: 18, waste: "$890/mo", status: "Overprovisioned" },
        ].map((cluster) => (
          <div key={cluster.name} className="bg-card border border-border rounded-xl p-6 hover:border-primary/20 transition-all">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center mt-4">
                ...
                <Button size="sm" variant="outline" className="h-8 text-[10px]">Optimize Nodes</Button>
              </div>
            </div>
          </div>
        ))}

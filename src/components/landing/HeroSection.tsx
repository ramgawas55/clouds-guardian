      ...
      <div className="container mx-auto px-4 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
            You probably have idle instances, forgotten snapshots, and oversized clusters
            quietly draining your cloud budget right now. We help you find them — and fix them — in minutes.
          </p>
